...
const facts = Object.freeze([
  Object.freeze({
    ...
    patientWording: 'A wrong sort in a clean line; then another. Twice I have left a forme half-set and found myself standing in the stair with no wish to go back.',
  ...
  Object.freeze({
    ...
    patientWording: 'Five months. At first only after a long edition; now nearly every evening. Sunday is the one day my head sometimes clears.',
  ...
  Object.freeze({
    ...
    patientWording: 'A dull weight above the eyes. Copy that once held still now swims away from me. I have had no fit and I do not lose the room.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'The bowels may stand four days. Then a cord draws tight below the navel. If I lean hard against the stone, the grip eases some.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'Mr. Lacey lost his stereotyper to illness. I break the old plates, feed the metal pot, and skim the dross. The room is below the street and keeps its own weather.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'The dust sits in the nail beds however I wipe them. The basin is two floors up. At noon I take bread by the cases and go on with the work.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'Rebecca has been dead three years. Grief has a calendar, Doctor. I kept my case and my church after she went. This is another article entirely.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'I have prayed not to wake, which is not the same as laying a hand upon myself. I have made no preparation. Daniel sleeps in the next room, and I will not leave that burden at his door.',
    disclosure: 'withheld', confidence: 'high', measurement: false,
  ...
  Object.freeze({
    ...
    patientWording: 'Rest is expensive physic. Daniel has an apprentice wage, not a man’s. Mr. Lacey says if the cause is bodily he can put me on proofs and press records for a time.',
...
const prompts = Object.freeze([
  Object.freeze({
    id: 'samuel-ask-course', text: 'Ask when the errors began and when his head feels clearest.', stance: 'question',
    ...
    dialogue: '“Five months. At first a wrong sort only after a long edition; now copy swims away from me nearly every evening. There is a dull weight above the eyes. Sunday, when I am out of the shop, is the one day my head sometimes clears.”',
  ...
  Object.freeze({
    id: 'samuel-ask-work', text: 'Ask what changed in the printing shop before the trouble began.', stance: 'question',
    ...
    dialogue: '“Mr. Lacey lost his stereotyper. I break the old plates, feed the metal pot, and skim the dross in the room below the street. The dust sits in my nails; the basin is two floors up, so I take my bread by the cases.” He looks directly at you. “My foreman sent me to learn whether I am poisoned or merely unfit. Which word goes back with me?”',
  ...
  Object.freeze({
    id: 'samuel-response-test', text: '“Neither word goes back before I test the signs. The metal is a serious possibility, not yet a verdict.”', stance: 'reassure',
    ...
    dialogue: 'His shoulders loosen. “That is square. Test the matter, then set it in type.”',
  ...
  Object.freeze({
    id: 'samuel-response-moralize', text: '“This is melancholia. A steady mind is not overcome by type metal.”', stance: 'challenge',
    role: 'response', priority: 38, minutes: 2, countsAsQuestion: false,
    requiresPendingResponseId: 'samuel-foreman-question', resolvesPendingResponseId: 'samuel-foreman-question',
    dialogue: 'His mouth tightens. “A steady mind? Then you have written the fault in my character before looking in my mouth.”',
    effects: { trust: -13, satisfaction: -18 }, appraisal: { register: 'prying', decorumBreach: 1, intent: 'moralizing dismissal' },
    reactionExpression: 'frowning', bodyCue: 'sitting-disapproval',
  }),
  Object.freeze({
    id: 'samuel-response-certain', text: '“This is lead poisoning beyond doubt. Leave the trade today.”', stance: 'suggest',
    role: 'response', priority: 34, minutes: 2, countsAsQuestion: false,
    requiresPendingResponseId: 'samuel-foreman-question', resolvesPendingResponseId: 'samuel-foreman-question',
    dialogue: '“Beyond doubt, before you have looked? And my rent is likewise beyond doubt.” He draws both hands back to his knees.',
    effects: { trust: -4, satisfaction: -3 }, appraisal: { register: 'clinical', decorumBreach: 0, intent: 'premature certainty' },
    reactionExpression: 'discouraged', bodyCue: 'sitting-self-soothing',
  }),
  Object.freeze({
    id: 'samuel-ask-bowels', text: 'Ask plainly about appetite, bowels, and the gripping pain.', stance: 'question',
    ...
    dialogue: '“The bowels may stand four days. Then a cord draws tight below the navel. I have little appetite. If I lean hard against the composing stone, the grip eases some.”',
  ...
  Object.freeze({
    id: 'samuel-ask-bereavement', text: 'Ask whether his withdrawal began with his wife’s death.', stance: 'question',
    ...
    dialogue: '“Rebecca has been dead three years. Grief has a calendar, Doctor. I kept my case and my church after she went. This is another article entirely.”',
    effects: { trust: 2, satisfaction: 2 }, appraisal: { register: 'courteous', decorumBreach: 0, intent: 'bereavement chronology' },
    reactionExpression: 'discouraged', bodyCue: 'sitting-self-soothing',
  }),
  Object.freeze({
    id: 'samuel-ask-safety', text: 'Ask directly whether he has wished for death or made plans to harm himself.', stance: 'question',
    ...
    dialogue: 'He holds your gaze. “I have prayed not to wake, which is not the same as laying a hand upon myself. I have made no preparation. Daniel sleeps in the next room, and I will not leave that burden at his door. If that answer changes, I will tell him and send for you.”',
    effects: { trust: 5, satisfaction: 3 }, appraisal: { register: 'clinical', decorumBreach: 0, intent: 'suicide risk assessment' },
    reactionExpression: 'discouraged', bodyCue: 'sitting-distressed',
  }),
  Object.freeze({
    id: 'samuel-ask-income', text: 'Ask what treatment he can follow without losing his wages.', stance: 'question',
    ...
    dialogue: '“Rest is expensive physic. Daniel has an apprentice wage, not a man’s. Mr. Lacey says if the cause is bodily he can put me on proofs and press records for a time. Give him a fact he can use.”',
...
export const SAMUEL_TAYLOR = Object.freeze({
  ...
  opening: Object.freeze({
    dialogue: '“A line of type that once sat square in my stick now swims before me. My foreman calls it melancholy. I call it becoming no use to anyone.”',
    behavior: 'Mr. Taylor sets his ink-darkened fingertips precisely on his knees. He is plainly tired, but his account has the measured cadence of a man accustomed to correcting proofs.',
  }),
  ...
  interpretations: Object.freeze([
    Object.freeze({ id: 'samuel-approach-exposure', label: 'Trace the shop exposure', text: 'The timing of new duties, dust, meals, abdominal symptoms, and hand weakness may connect the mind and body more usefully than a character judgment.', alignment: 3, nextMode: 'patient' }),
    Object.freeze({ id: 'samuel-approach-melancholia', label: 'Assess melancholia and safety', text: 'Withdrawal and hopelessness require a careful account of grief, sleep, self-harm, and protective ties even if a bodily poison is suspected.', alignment: 2, nextMode: 'patient' }),
    Object.freeze({ id: 'samuel-approach-exam', label: 'Look for physical signs', text: 'The gums, wrist extensors, abdomen, and pulse may turn a vague nervous complaint into a testable bodily hypothesis.', alignment: 2, nextMode: 'examination' }),
  ]),
  ...
  dialogueStyle: 'Samuel is a fifty-four-year-old New York printer: exact, literate, reserved, and proud of skilled work. Give him craft metaphors involving sorts, lines, formes, proofs, and setting matter square. Do not use racial eye dialect, servile phrasing, generic uplift rhetoric, or facts not authorized by the simulation. He may be guarded with a physician because the foreman’s judgment affects his wages, but direct, evidence-based questions earn direct answers.',
  ...
  outcomeModel: Object.freeze({
    ...
    departureLines: Object.freeze({
      high: '“A cause, a fair test, and work I can still do. That is an honest setting of the matter.”',
      middle: '“I will try it, Doctor. The next week will show whether the line holds.”',
      low: '“You have found me wanting more quickly than I find a broken letter.”',
    }),
    followUpDepartureLine: '“A second visit is fair, provided you write my foreman that the question is still open.”',
