...
const prompts = Object.freeze([
  Object.freeze({
    ...
    dialogue: '“It’d be five months now, near enough. At first only after a long edition — you’re at the case fourteen hours and your eyes go, so I thought nothing of it. Now it’s most evenings, and there’s an ache over my eyes with it. Sundays I’m out of the shop, and that’s the one day it lifts.”',
  ...
  Object.freeze({
    ...
    dialogue: '“Mr. Lacey lost his stereotyper in the spring, so I’ve had that work along with my own. Breaking up old plates, feeding the metal pot, skimming the dross. It’s a back room below the street with no window, and the dust gets into your hands and won’t wash out. The basin’s two floors up, so I take my bread at the cases.” He looks directly at you. “He wants to know is it the metal or is it me. I told him I’d ask.”',
  ...
  Object.freeze({
    ...
    dialogue: 'His shoulders loosen. “That’s fair enough. Find out what it is and tell me straight.”',
  ...
  Object.freeze({
    ...
    requiresPendingResponseId: 'samuel-foreman-question', resolvesPendingResponseId: 'samuel-foreman-question',
    dialogue: 'His mouth tightens. “You’ve decided it’s my character, then, and you’ve not so much as looked at me.”',
  ...
  Object.freeze({
    ...
    requiresPendingResponseId: 'samuel-foreman-question', resolvesPendingResponseId: 'samuel-foreman-question',
    dialogue: '“Beyond doubt, and you’ve not examined me. It’s easy said, sir. I’ve a rent to pay.” He draws both hands back to his knees.',
  ...
  Object.freeze({
    ...
    dialogue: '“I’ve been badly constipated, sir. Four days at a stretch sometimes, and then a pain comes low down and grips at me an hour or two. Pressing hard on it helps, so I do that when I can. And I’ve not much appetite, though I make myself eat something at noon.”',
  ...
  Object.freeze({
    ...
    dialogue: '“Three years this January. I took it very hard at the time, I won’t pretend otherwise. But I kept at my work and I kept going to church, and I was all right, near enough. This other business only started in the spring.”',
  ...
  Object.freeze({
    ...
    dialogue: 'He holds your gaze. “There have been mornings I’ve prayed not to wake up. I’ve never done anything about it and I don’t intend to. Daniel sleeps in the next room, and I’d not do that to him. If it changes I’ll tell him and send for you.”',
  ...
  Object.freeze({
    ...
    dialogue: '“I can’t stop work, sir, that’s the trouble of it. Daniel’s on an apprentice wage and there’s the rent. Mr. Lacey did say that if it turns out to be something in the body he could put me on proofs and press records a while at the same money — but he’d want it in writing from a doctor first.”',
...
export const SAMUEL_TAYLOR = Object.freeze({
  ...
  opening: Object.freeze({
    dialogue: '“I’ve been at the case thirty years, sir, and I was always reliable. Now I’m setting wrong letters and not catching them, and twice I’ve walked off and left a forme half done. My foreman says it’s melancholy. I don’t know what it is.”',
