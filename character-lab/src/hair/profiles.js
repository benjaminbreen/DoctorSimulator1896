export const HAIR_PROFILES = Object.freeze({
  'center-parted-bun': {
    part: 'center', partAzimuth: 0, frontDepth: 0.44, sideDepth: 0.88, napeDepth: 0.94,
    crown: 1, sides: 0.82, templePuff: 0.76, mass: 'bun', bunHeight: 0.16,
    bunScale: [1, 0.86, 0.72], flowGuideRow: 0.29, flowAnchorRow: 0.58,
  },
  'side-parted-bun': {
    part: 'side', partAzimuth: 0.40, frontDepth: 0.43, sideDepth: 0.86, napeDepth: 0.94,
  ...
  'low-bun': {
    part: 'center', partAzimuth: 0, frontDepth: 0.45, sideDepth: 0.90, napeDepth: 0.98,
  ...
  'coiled-bun': {
    part: 'center', partAzimuth: 0, frontDepth: 0.43, sideDepth: 0.87, napeDepth: 0.93,
  ...
  'loose-chignon': {
    part: 'center', partAzimuth: 0, frontDepth: 0.45, sideDepth: 0.91, napeDepth: 0.98,
  ...
  'swept-back': {
    part: null, partAzimuth: 0, frontDepth: 0.42, sideDepth: 0.88, napeDepth: 0.94,
  ...
  pompadour: {
    part: null, partAzimuth: 0, frontDepth: 0.41, sideDepth: 0.86, napeDepth: 0.93,
  ...
  'braided-crown': {
    part: null, partAzimuth: 0, frontDepth: 0.45, sideDepth: 0.87, napeDepth: 0.91,
