/** Social and household tables for the clinic sample, not the city at large. */
...
export const OCCUPATIONS = [
  { id: 'household', label: 'no separate paid occupation', weight: 30, classes: ['elite', 'affluent', 'comfortable'], minAge: 16 },
  { id: 'society-hostess', label: 'society hostess', weight: 9, classes: ['elite'], minAge: 25 },
  ...
  { id: 'governess', label: 'governess', weight: 9, classes: ['comfortable', 'sponsored'], minAge: 19 },
  ...
  { id: 'dressmaker', label: 'dressmaker', weight: 12, classes: ['comfortable', 'sponsored'], minAge: 18 },
  { id: 'seamstress', label: 'seamstress', weight: 11, classes: ['sponsored'], minAge: 16 },
  { id: 'domestic-servant', label: 'domestic servant', weight: 13, classes: ['sponsored'], minAge: 16 },
  { id: 'laundress', label: 'laundress', weight: 7, classes: ['sponsored'], minAge: 18 },
  { id: 'nurse', label: 'trained nurse', weight: 7, classes: ['affluent', 'comfortable'], minAge: 22 },
