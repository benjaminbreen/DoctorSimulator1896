/**
 * Compact demographic profiles for New York City in 1896.
 *
...
export const ORIGIN_PROFILES = [
  {
    id: 'old-stock-american', label: 'old-stock American', cityWeight: 24,
  ...
  {
    id: 'german-american', label: 'German American', cityWeight: 22,
  ...
  {
    id: 'irish-american', label: 'Irish American', cityWeight: 25,
    access: { elite: 0.65, affluent: 0.8, comfortable: 0.9, sponsored: 1.25 },
    generations: [[1, 5], [2, 5], [3, 1]], heritage: [0.01, 0.01, 0.98],
  ...
  {
    id: 'ashkenazi-jewish', label: 'Ashkenazi Jewish', cityWeight: 11,
  ...
  {
    id: 'italian', label: 'Italian immigrant', cityWeight: 7,
  ...
  {
    id: 'african-american', label: 'African American', cityWeight: 3,
  ...
  {
    id: 'eastern-european', label: 'Eastern European immigrant', cityWeight: 6,
  ...
  {
    id: 'chinese-american', label: 'Chinese American', cityWeight: 0.7,
