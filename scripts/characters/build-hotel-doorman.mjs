...
const PROFILES = Object.freeze({
  ...
  maid: Object.freeze({
    label: 'Hotel maid',
    generated: 'hotel-maid',
    source: 'African American Maid Idle.fbx',
    modelRaw: 'hotel-maid.raw.glb',
    modelOutput: 'hotel-maid.glb',
    // Crowd slots resolve an idle by this name; see Pedestrians.jsx.
    modelClip: 'StandingIdle',
    expectedBones: 65,
    motions: Object.freeze([]),
    sharesMotions: 'strawhat-motions.glb',
  }),
  bellhop: Object.freeze({
    label: 'Hotel bellhop',
    generated: 'hotel-bellhop',
    source: 'African American Bellhop Skinned Idle.fbx',
    modelRaw: 'hotel-bellhop.raw.glb',
    modelOutput: 'hotel-bellhop.glb',
    modelClip: 'StandingIdle',
    expectedBones: 65,
    motions: Object.freeze([]),
    sharesMotions: 'strawhat-motions.glb',
