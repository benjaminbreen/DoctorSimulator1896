...
const counters = { sex: {}, origin: {}, class: {}, occupation: {}, clinical: {}, outfit: {}, hair: {}, eyes: {} };
...
for (let seed = 1; seed <= count; seed += 1) {
  ...
  increment('sex', patient.identity.sex); increment('origin', patient.identity.origin.id); increment('class', patient.social.classId);
